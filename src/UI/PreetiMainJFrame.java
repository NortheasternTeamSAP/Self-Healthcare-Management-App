 ...
 * @author preet
 */
public class PreetiMainJFrame extends javax.swing.JFrame {
...
//        System.out.println("" + p.getCounsellingNotes());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreetiMainJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreetiMainJFrame().setVisible(true);
            }
        });
    }
